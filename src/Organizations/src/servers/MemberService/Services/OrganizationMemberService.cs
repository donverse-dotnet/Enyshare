...
{
  // MongoDBのメンバーコレクション
  private readonly ImongocCollection<MemberEntity> _members;
  ...
  /// </summary>
  public override async Task<CreateMemberReply> Create(CreateMemberRequest request, ServerCallContext context)
  {
  ...
  /// </summary>
  public override async Task<UpdateMemberReply> Update(UpdateMemberRequest request, ServerCallContext context)
  {
  ...
  /// </summary>
  public override async Task<DeleteMemberReply> Delete(DeleteMemberRequest request, ServerCallContext context)
  {
